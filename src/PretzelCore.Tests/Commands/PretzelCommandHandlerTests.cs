...
namespace Pretzel.Tests.Commands
{
    public class PretzelCommandHandlerTests
    {
        ...
        public async Task CommandParametersGetsBinded()
        {
            ...
            rootCommand.AddOption(new Option("--someoption", argumentType: typeof(bool)));
        ...
        public class TestArguments2 : ICommandArguments
        {
            ...
            {
                new ExportFactory<ICommandArgumentsExtension, CommandArgumentsExtensionAttribute>(() => Tuple.Create<ICommandArgumentsExtension, Action>(Args, new Action(() => { })), new CommandArgumentsExtensionAttribute{ CommandTypes = new []{ typeof(TestArguments2)} })
            };
        ...
        {
            var rootCommand = new RootCommand();
            rootCommand.AddOption(new Option("--otheroption", argumentType: typeof(bool)));

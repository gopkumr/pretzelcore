...
namespace Pretzel.Tests.Templating.Context
{
    public class PageContextTests
    {
        ...
        public void config_permalink_sets_relative_file_output_path()
        {
            ...
            configDictionary.Add("permalink", "/blog/:year/:month/:day/:title.html");
            context.Config = new ConfigurationMock(configDictionary);
        ...
        {
            var context = new SiteContext();
            context.Config = new ConfigurationMock(new Dictionary<string, object>());

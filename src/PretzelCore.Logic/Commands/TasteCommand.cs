...
namespace Pretzel.Logic.Commands
{
    ...
    public class TasteCommandArguments : BakeBaseCommandArguments
    {
        ...
        {
            new Option(new[] { "--port", "-p" }, "The port to test the site locally", getDefaultValue: ()=>8080),
            new Option("--nobrowser", "Do not launch a browser (false by default)", argumentType: typeof(bool))
        });

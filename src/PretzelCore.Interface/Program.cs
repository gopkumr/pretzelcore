...
#pragma warning disable S2223 // Non-constant static fields should not be visible
        ...
        public static Option[] GlobalOptions = new[]
        {
            ...
            new Option(new[] { "--source", "-s" }, "The path to the source site (default current directory)", getDefaultValue: ()=>fileSystem.Directory.GetCurrentDirectory())
        };
        ...
        public static CompositionHost Compose(bool debug, bool safe, string path)
        {
            try
            {
                ...
                configuration
                    ...
                    .WithAssembly(typeof(SanityCheck).Assembly)
                    .WithAssembly(Assembly.GetAssembly(typeof(CommandCollection)))
                    ;
